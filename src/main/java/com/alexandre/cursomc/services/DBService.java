...
public class DBService {
	...
	public void instanciateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "alexandre.ntr@gmail.com", "10254226545", TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		cli1.getTelefones().addAll(Arrays.asList("1321321", "6165611"));
		
		Endereco e1 = new Endereco(null, "Rua flores", "300", "Apto 300", "Jardim", "51616", cli1, c1);
